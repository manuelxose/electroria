...
Use `generate_image` whenever a task needs a real shipped visual asset instead of only written copy, for example hero images, service images, social cards, blog covers, banners, or other branded visuals.
